        ...
        {products.map((product) => {
          ...
          return (
            ...
            >
              ...
              <div className="aspect-square relative rounded-xl overflow-hidden bg-[#f8f9fa] group-hover:bg-black transition-all duration-300 group-hover:shadow-xl group-hover:shadow-black/20 mb-3 border border-[#f1f3f4] group-hover:border-transparent">
                {imgSrc ? (
                  <Image
                    src={imgSrc}
